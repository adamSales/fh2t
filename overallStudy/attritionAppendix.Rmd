...
Table 1: Attrition rates by experimental condition:
```{r attritionTable}
tab=rbind(
  `# Randomized`=Ncond,
...
Table 2: Overall attrition for pairwise comparisons in the lower triangular, and the differential attrition in the upper triangular
