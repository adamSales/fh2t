...
Model 7 estimated a marginally-significant (p=`r round(mod7$p.value['conditionInstant:pretest'],3)`) positive interaction between the effect of being assigned to the Instant condition and pretest scores--i.e. that the effect becomes larger (more positive) as pretest scores increase.
